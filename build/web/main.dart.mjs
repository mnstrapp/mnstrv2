...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1282: x0 => x0.getVideoTracks(),
      _1283: x0 => x0.getSupportedConstraints(),
      _1284: x0 => ({video: x0}),
      _1285: x0 => ({facingMode: x0}),
      _1286: (x0,x1) => x0.getUserMedia(x1),
      ...
      _1289: (x0,x1) => x0.removeChild(x1),
      _1290: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1290(f,arguments.length,x0) }),
      _1291: (x0,x1) => x0.appendChild(x1),
      _1292: () => new Map(),
      _1293: (x0,x1,x2) => x0.set(x1,x2),
      _1294: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1295: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1295(f,arguments.length,x0,x1) }),
      _1296: (x0,x1) => new ZXing.BrowserMultiFormatReader(x0,x1),
      _1298: x0 => x0.play(),
      ...
      _1348: x0 => x0.barcodeFormat,
      _1349: x0 => x0.text,
      _1350: x0 => x0.rawBytes,
      _1351: x0 => x0.resultPoints,
      _1353: Date.now,
      ...
      _1483: (x0,x1) => new WebSocket(x0,x1),
      _1484: (x0,x1) => x0.send(x1),
      _1485: (x0,x1,x2) => x0.close(x1,x2),
      _1487: x0 => x0.close(),
      _1488: () => new AbortController(),
      _1489: x0 => x0.abort(),
      _1490: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1491: (x0,x1) => globalThis.fetch(x0,x1),
      _1492: (x0,x1) => x0.get(x1),
      _1493: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1493(f,arguments.length,x0,x1,x2) }),
      _1494: (x0,x1) => x0.forEach(x1),
      _1495: x0 => x0.getReader(),
      _1496: x0 => x0.read(),
      _1497: x0 => x0.cancel(),
      _1498: x0 => globalThis.URL.createObjectURL(x0),
      _1500: x0 => ({type: x0}),
      _1501: (x0,x1) => new Blob(x0,x1),
      _1502: () => new XMLHttpRequest(),
      _1503: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1504: x0 => x0.send(),
      _1506: () => new FileReader(),
      _1507: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1519: x0 => x0.attachStreamToVideo,
      _1521: x0 => x0.decodeContinuously,
      _1525: x0 => x0.reset,
      _1527: x0 => x0.stopContinuousDecode,
      _1529: x0 => x0.stream,
      _1530: x0 => x0.videoElement,
      _1531: (x0,x1) => x0.key(x1),
      _1533: x0 => x0.facingMode,
      _1534: x0 => x0.getSettings(),
      _1535: (x0,x1) => ({width: x0,height: x1}),
      _1536: (x0,x1,x2) => ({width: x0,height: x1,facingMode: x2}),
      _1546: (s, m) => {
        try {
      ...
      _1760: (x0,x1) => { x0.lang = x1 },
      _1789: x0 => x0.style,
      _1848: (x0,x1) => { x0.onerror = x1 },
      _1864: (x0,x1) => { x0.onload = x1 },
      _1888: (x0,x1) => { x0.onpause = x1 },
      _1890: (x0,x1) => { x0.onplay = x1 },
      _2148: (x0,x1) => { x0.download = x1 },
      _2173: (x0,x1) => { x0.href = x1 },
      ...
      _3029: (x0,x1) => { x0.defer = x1 },
      _3031: (x0,x1) => { x0.crossOrigin = x1 },
      _3490: () => globalThis.window,
      _3552: x0 => x0.navigator,
      _3816: x0 => x0.localStorage,
      _3923: x0 => x0.mediaDevices,
      _3939: x0 => x0.userAgent,
      _3940: x0 => x0.vendor,
      _3990: x0 => x0.data,
      _4147: x0 => x0.length,
      _4364: x0 => x0.readyState,
      _4373: x0 => x0.protocol,
      _4377: (x0,x1) => { x0.binaryType = x1 },
      _4380: x0 => x0.code,
      _4381: x0 => x0.reason,
      _6046: x0 => x0.type,
      _6087: x0 => x0.signal,
      ...
      _6241: x0 => x0.body,
      _6243: x0 => x0.head,
      _6573: (x0,x1) => { x0.id = x1 },
      _6600: x0 => x0.children,
      _7919: x0 => x0.value,
      _7921: x0 => x0.done,
      _8105: (x0,x1) => { x0.type = x1 },
      _8121: x0 => x0.result,
      _8618: x0 => x0.url,
      _8620: x0 => x0.status,
      ...
      _8624: x0 => x0.body,
      _9426: x0 => x0.label,
      _9448: x0 => x0.facingMode,
      _9662: x0 => x0.width,
      _9664: x0 => x0.height,
      _9670: x0 => x0.facingMode,
      _11026: (x0,x1) => { x0.display = x1 },
      _11190: (x0,x1) => { x0.height = x1 },
      _11384: (x0,x1) => { x0.objectFit = x1 },
      _11514: (x0,x1) => { x0.pointerEvents = x1 },
      _11812: (x0,x1) => { x0.transform = x1 },
      _11816: (x0,x1) => { x0.transformOrigin = x1 },
      _11880: (x0,x1) => { x0.width = x1 },
      _12248: x0 => x0.name,
      _12249: x0 => x0.message,
      _12996: x0 => x0.message,
